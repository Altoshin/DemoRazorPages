...
using DemoRazorPages.Implementazione;
using DemoRazorPages.Interfacce;
using DemoRazorPages.Services.Implementations;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            services.AddDbContext<CustomersDbContext>(
                opzioni =>
                {
                    opzioni.UseInMemoryDatabase("DatabaseCustomers");
                });
        ...
        {
            services.AddScoped<IMessage, StaticMessage>();
            services.AddScoped<ICustomersData, SQLServerCustomersData>();
        }
